...
namespace ElectronicLibraryAPI2.Controllers
{
    ...
    public class PublishersController : ControllerBase
    {
        ...
        public PublishersController(Library_DatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Publisher>> PostPublisher(Publisher publisher)
        {
          if (_context.Publishers == null)
          {
              return Problem("Entity set 'Library_DatabaseContext.Publishers'  is null.");
          }
            _context.Publishers.Add(publisher);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetPublisher", new { id = publisher.IdPublisher }, publisher);
        }
