...
namespace ElectronicLibraryAPI2.Controllers
{
    ...
    public class AuthorsController : ControllerBase
    {
        ...
        public AuthorsController(Library_DatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Author>> PostAuthor(Author author)
        {
          if (_context.Authors == null)
          {
              return Problem("Entity set 'Library_DatabaseContext.Authors'  is null.");
          }
        ...
        {
            return (_context.Authors?.Any(e => e.IdAuthor == id)).GetValueOrDefault();
        }
    }
}
